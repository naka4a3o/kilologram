...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post calendars_url, params: { calendar: { name: @calendar.name, start_time: @calendar.start_time } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { name: @calendar.name, start_time: @calendar.start_time } }
